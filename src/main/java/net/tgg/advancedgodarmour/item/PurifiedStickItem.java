...
public class PurifiedStickItem extends AdvancedGodArmourModElements.ModElement {
	@ObjectHolder("advanced_god_armour:purified_stick")
	public static final Item block = null;

	public PurifiedStickItem(AdvancedGodArmourModElements instance) {
		super(instance, 32);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("purified_stick");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Special Stick Used By All Weapons In This Mod"));
		}
	}
}
