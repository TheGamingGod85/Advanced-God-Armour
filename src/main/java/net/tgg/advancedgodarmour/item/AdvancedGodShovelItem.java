...
public class AdvancedGodShovelItem extends AdvancedGodArmourModElements.ModElement {
	@ObjectHolder("advanced_god_armour:advanced_god_shovel")
	public static final Item block = null;

	public AdvancedGodShovelItem(AdvancedGodArmourModElements instance) {
		super(instance, 20);
	}
	...
	public void initElements() {
		elements.items.add(() -> new ShovelItem(new IItemTier() {
			...
			public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
				...
				list.add(new StringTextComponent("Tool USed To Shovel Up The Grass Created By The God"));
			}
		...
		}.setRegistryName("advanced_god_shovel"));
	}
}
