...
public class AdvancedGodAxeItem extends AdvancedGodArmourModElements.ModElement {
	@ObjectHolder("advanced_god_armour:advanced_god_axe")
	public static final Item block = null;

	public AdvancedGodAxeItem(AdvancedGodArmourModElements instance) {
		super(instance, 18);
	}
	...
	public void initElements() {
		...
		}, 1, 16f, new Item.Properties().group(AdvancedGodArmourTabItemGroup.tab).isImmuneToFire()) {
			@Override
			public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
				super.addInformation(itemstack, world, list, flag);
				list.add(new StringTextComponent("God Hid This Weapon From Everyone"));
				list.add(new StringTextComponent("Maybe Its Too Strong For Human Usage"));
			}
		...
		}.setRegistryName("advanced_god_axe"));
	}
}
